...
u1 = List.create :title => 'Portfolio', :buy_price => '12.34', :admin => true
u2 = List.create :email => 'craigsy@ga.co', :password => 'chicken'
puts "#{ List.count} users created"
...
puts "#{ Artist.count } aartists created"
