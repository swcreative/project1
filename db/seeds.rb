...
Note.destroy_all
n1 = Note.create :title => 'What the drought means for your share portfolio', :date => '02/11/2019', :post => 'With agriculture stocks at all-time lows, we outline the risks and opportunities.'
...
Share.destroy_all
s1 = Share.create :code => 'ANZ', :price => '26.19', :name => 'ANZ Bank'
s2 = Share.create :code => 'CBA', :price => '78.24', :name => 'Commonwealth Bank of Australia'
s3 = Share.create :code => 'ORI', :price => '23.73'
s4 = Share.create :code => 'BHP', :price => '35.70', :name => 'BHP Limited'
s5 = Share.create :code => 'APT', :price => '27.45', :name => 'Afterpay'
s6 = Share.create :code => 'XRO', :price => '69.91', :name => 'Xero'
s7 = Share.create :code => 'CSR', :price => '4.43', :name => 'CSR'
s8 = Share.create :code => 'BLD', :price => '27.45'
s9 = Share.create :code => 'MQG', :price => '134.38'
